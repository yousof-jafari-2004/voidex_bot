...
✅ مراحل استفاده:
    ...
    انجام خرید
        ...
        وارد 'تمامی پلن ها' شو و بسته‌ی موردنظرت رو انتخاب کن.

        بعد مدت زمان بسته رو انتخاب کن

        پرداختت که انجام شد، یه رسید تصویری از خریدت میفرستی.

    ارسال رسید

        📸 تنها کاری که باید انجام بدی اینه که یه عکس از رسیدت برای ربات بفرستی.

        نیازی نیست چیزی توضیح بدی یا کاری بکنی، ربات به‌صورت خودکار رسیدتو بررسی می‌کنه و اگر معتبر باشه بسته ات رو فعال می‌کنه! 🎁
        
      اگه سوال دیگه ای داری میتونی از منوی اصلی گزینه 'پشتیبانی و سوالات' کنی
  `);
})
