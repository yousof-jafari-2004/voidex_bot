...
bot.action('basic', (ctx) => {
  ctx.reply(`سرویس مورد نظر را انتخاب کنید
    ...
    Markup.inlineKeyboard([
      [Markup.button.callback('سرویس یک ماهه | ۶۸ هزار تومان', '1_mounth')],
      [Markup.button.callback('سرویس سه ماهه | ۱۷۸ هزار تومان', '3_mounth')],
      [Markup.button.callback('سرویس شش ماهه | ۳۵۶ هزار تومان', '6_mounth')],
    ])
  );
});
bot.action('pro', (ctx) => {
  ctx.reply(`سرویس مورد نظر را انتخاب کنید`,
    Markup.inlineKeyboard([
      [Markup.button.callback('سرویس یک ماهه | ۹۸ هزار تومان', '1_mounth')],
      [Markup.button.callback('سرویس سه ماهه | ۲۶۸ هزار تومان', '3_mounth')],
      [Markup.button.callback('سرویس شش ماهه | ۵۳۶ هزار تومان', '6_mounth')],
    ])
  );
});
bot.action('vip', (ctx) => {
  ctx.reply(`سرویس مورد نظر را انتخاب کنید`,
    Markup.inlineKeyboard([
      [Markup.button.callback('سرویس یک ماهه | ۱۳۸ هزار تومان', '1_mounth')],
      [Markup.button.callback('سرویس سه ماهه | ۳۸۸ هزار تومان', '3_mounth')],
      [Markup.button.callback('سرویس شش ماهه | ۷۷۶ هزار تومان', '6_mounth')],
    ])
  );
});

bot.action('1_mounth', (ctx) => {
  ctx.reply(`
    ...
    حسین جعفری
    ___________________
    پس از فعال سازی شما میتوانید با دستور /currentService اطلاعات بسته خود را لحظه به لحظه برسی کنید
  `)
});
bot.action('3_mounth', (ctx) => {
    ctx.reply(`
    لطفا مبلغ ${price} تومان را به شماره کارت زیر انتقال داده و تصویر رسید را ارسال کنید
    سرویس مورد نظر تا ۱ ساعت بعد از ارسال تصویر به صورت خودکار فعال سازی میشود و توسط همین بات تلگرام به شما اطلاع داده میشود
    ___________________
